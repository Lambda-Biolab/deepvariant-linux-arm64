...
#     -t ghcr.io/lambda-biolab/deepvariant-linux-arm64:base-builder-v1.10.0 .
#   docker push ghcr.io/lambda-biolab/deepvariant-linux-arm64:base-builder-v1.10.0
#
...
# Reason: chmod all scripts — build-prereq-arm64.sh executes run-prereq.sh directly
